...
BATCH_SIZE = 128
NUM_EPOCHS = 5                # 每多训练n轮，就给已有数字加n
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
CHECKPOINT_PATH = "model/rotation_checkpoint.pth" # 存档
...
ENCODER_OUTPUT_PATH = "./model/cifar10_rotnet_encoder.pth"
